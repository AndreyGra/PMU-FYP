	IoTOctopus_QSYS u0 (
		.adc_control_pins_external_export (<connected-to-adc_control_pins_external_export>), // adc_control_pins_external.export
		.adc_spi_master_external_MISO     (<connected-to-adc_spi_master_external_MISO>),     //   adc_spi_master_external.MISO
		.adc_spi_master_external_MOSI     (<connected-to-adc_spi_master_external_MOSI>),     //                          .MOSI
		.adc_spi_master_external_SCLK     (<connected-to-adc_spi_master_external_SCLK>),     //                          .SCLK
		.adc_spi_master_external_SS_n     (<connected-to-adc_spi_master_external_SS_n>),     //                          .SS_n
		.clk_32mhz_input_clk              (<connected-to-clk_32mhz_input_clk>),              //           clk_32mhz_input.clk
		.clk_8mhz_clk                     (<connected-to-clk_8mhz_clk>),                     //                  clk_8mhz.clk
		.clk_8mhz_locked_export           (<connected-to-clk_8mhz_locked_export>),           //           clk_8mhz_locked.export
		.gps_uart_external_rxd            (<connected-to-gps_uart_external_rxd>),            //         gps_uart_external.rxd
		.gps_uart_external_txd            (<connected-to-gps_uart_external_txd>),            //                          .txd
